<template>
  <div class="chatbot-kconsultores-container">
    <div class="chat-header">
       <v-icon color="#ffb300" class="me-1">mdi-trophy</v-icon>
      <v-icon color="#388e3c" class="me-1">mdi-soccer</v-icon>
      <span class="font-weight-bold ms-2">ChatbotReto97</span>
    </div>
...
import { AxiosChatbotKConsultoresService } from '../infrastructure/chat/AxiosChatbotReto97ConsultoresService';
...
export default defineComponent({
  ...
  setup() {
    const input = ref('');
    const messages = ref([
      { from: 'bot', text: '¡Hola! Soy tu asesor virtual de Reto97, ¿cómo puedo ayudarte?' }
    ]);
